...
public class DriveUtils {
    ...
    public static Drive drive() {
        ...
        try {
            ...
            Drive service = new Drive.Builder(HTTP_TRANSPORT, GoogleAuthUtils.JSON_FACTORY, GoogleAuthUtils.getCredentials(HTTP_TRANSPORT))
    ...
    public static Sheets sheets() {
        ...
        try {
            final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
            Sheets service = new Sheets.Builder(HTTP_TRANSPORT, GoogleAuthUtils.JSON_FACTORY, GoogleAuthUtils.getCredentials(HTTP_TRANSPORT))
                .setApplicationName(GoogleAuthUtils.getGoogleWsConfig().getApplicationName())
                .build();
            return service;
        } catch (GeneralSecurityException | IOException e) {
    ...
    public static String storeInDrive(File file) throws IOException {
        ...
        com.google.api.services.drive.model.File driveFile = drive.files()
